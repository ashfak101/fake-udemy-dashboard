                ...
                <Box>
                  <Box sx={{ px: { xs: 2, md: 14 }, py: 4 }}>
                    ...
                    {isCorrect === "Incorrect" ? (
                      ...
                      >
                        {" "}
                        <ClearIcon></ClearIcon> Incorrect answer. Please try
                        again
                      </Typography>
                    ) : (
                      ""
                  ...
                  {!quizStart && (
                    ...
                    >
                      <Box>
                        <Typography
                          variant="h4"
                          sx={{ fontFamily: "Popins", fontWeight: "700" }}
                        >
                          {module?.lessonTitle}
                        </Typography>
                        <Typography
                          sx={{ fontFamily: "Popins", fontSize: "20px", my: 2 }}
                        >
                          Quiz 1 | 5 question
                        </Typography>
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      {isCorrect == "Correct" ? (
                        ...
                        >
                          {currentQ == 4 ? "See Result" : "next"}
                        </Button>
                      ) : (
                        <>
                          {currentQ > 5 ? (
                            <Button onClick={handleRetry}>HEllo</Button>
                          ) : (
                            <Button
